<div id="information" class="dynamic">
    <h3 class="header"><?=$this->lang->line('in_level')?> <?=$this->Player_Model->levels[$this->Player_Model->town_id][16]+1?></h3>
	<div class="content">
        <table width="100%">
            <tr>
            ...
            <tr>
                ...
                <td class="center">+<?=($this->Player_Model->levels[$this->Player_Model->town_id][16]+1)*2?>.00%</td>
            </tr>
        </table>
    </div>
