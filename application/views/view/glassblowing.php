...
?>
    <div class="contentBox01h">
        <div class="buildingPictureImg"><img src="<?=$this->config->item('style_url')?>skin/img/city/small/building_glassblowing.gif" /></div>
        <h3 class="header"><span class="textLabel"><?=$this->lang->line('glasblower_statistic')?></span></h3>
        <div class="content">
            <table cellspacing="0" cellspacing="0" border="0" style="margin:0 auto 0px;">
                ...
                <tr class='alt'>
                    <td class="col1Style">
                        <label><?=$this->lang->line('building18_name')?>: </label>
                    </td>
                    <td class="col2Style">
                        <span title="<?=$this->lang->line('building18_name')?>"><?=number_format($bonus)?></span>
                    </td>
                    <td class="col3Style">
