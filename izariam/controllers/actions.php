                ...
                if (isset($_POST['name']))
                {
                    ...
                    if ($login != $this->Player_Model->user->login)
                    {
                        ...
                        else
                        {
                            ...
                            $this->session->set_flashdata(array('options_error_login' => $this->lang->line('name').' '.$login.' '.$this->lang->line('taken')));
                        }
                    }
                }
            ...
            case 'validationEmail':
                ...
                if ($this->config->item('game_email'))
                {
                    $message = '
                        <html>
                        <body>
                         <p>'.$this->lang->line('register_email_text_1').' '.$this->Player_Model->user->login.', <br>
                         ...
                         <br>'.$this->lang->line('name').': '.$this->Player_Model->user->login.'
    ...
    function transport($island = 0, $town = 0)
    {
        ...
        if ($this->Player_Model->now_town->actions > 0)
        {
            if ($island > 0 and $town >= 0)
            {
				...
				{
					$this->show('error','The trade fleet doesn`t have any freight');
				}
            }
			else
			{
