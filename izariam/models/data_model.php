...
class Data_Model extends Model
{
    ...
    function army_name_by_type($type)
    {
        switch($type)
        {
            ...
            case 24: return $this->lang->line('army24_name'); break;
            case 25: return $this->lang->line('army25_name'); break;
            case 26: return $this->lang->line('army26_name'); break;
            case 27: return $this->lang->line('army27_name'); break;
        }
    }

    /**
     * Description of units by type
     * @param <int> $type
     * @return <string>
     */
    function army_desc_by_type($type)
    {
        switch($type)
        {
            ...
            case 24: return $this->lang->line('army24_desc'); break;
            case 25: return $this->lang->line('army25_desc'); break;
            case 26: return $this->lang->line('army26_desc'); break;
            case 27: return $this->lang->line('army27_desc'); break;
        }
    }

    /**
     * Class of units by type
     * @param <int> $type
     * @return <string>
     */
    ...
    function army_cost_by_type($type, $research, $levels, $use_research = TRUE)
    {
        ...
        /**
         * Abilities:
         * 1 - Stability - Increased security forces by 30% when the unit is involved in the protection of
         * 2 - Attack - Attack power increased by 30% when the unit is involved in the attack
         * 3 - Battering ram - The ability to disrupt the City Wall at the siege of the city. During one battle in a wall can make as many breaches, how many levels it is a breach imeet.Kazhdy adds 10% attack power hitters troops.
         *     The estimated probability of the break wall to rams, percent = 2 / level walls
         *     The estimated probability of the break wall for catapults, as a percentage = 3 / level walls
         *     The estimated probability of the break wall for mortar, percent = 4 / level walls
         * 4 - Recovery - The ability to recover stamina per round in damaged units. If in a fight involving several units with this ability, the effect of accumulated
         * 5 - Doctor
         */
        ...
        if ($use_research)
        {
            // Reduce the amount of research ships
            if ($type >= 15)
            {
                // Repair of ships
        ...
        // Reduce the time of construction of the level of the building
        switch($type)
        {
    ...
    /**
     * The name of the building by type
     * @param <int> $type
     * @return <string>
     */
    function building_name_by_type($type)
    {
        switch($type)
        {
            ...
            case 27: return $this->lang->line('building27_name'); break;
            default: return $this->lang->line('building0_name'); break;
        }
    }

    /**
     * Description of the building by type
     * @param <int> $type
     * @return <string>
     */
    function building_desc_by_type($type)
    {
        switch($type)
        {
            ...
            case 27: return $this->lang->line('building27_desc');
        }
    }
    ...
    function building_type_by_class($class)
    {
        switch($class)
        {
            ...
            case 'dump': return 27; break;
        }
    }

    /**
     * Building class by type
     * @param <int> $type
     * @return <string>
     */
    function building_class_by_type($type)
    {
        switch($type)
        {
            ...
            case 27: return 'dump'; break;
            default: return 'buildingGround'; break;
        }
    }

    /**
     * Name of of the resource by type
     * @param <int> $type
     * @return <string>
     */
    function resource_name_by_type($type)
    {
        switch($type)
        {
            case 1: return $this->lang->line('wine'); break;
            case 2: return $this->lang->line('marble'); break;
            case 3: return $this->lang->line('crystal'); break;
            case 4: return $this->lang->line('sulfur'); break;
            default: return $this->lang->line('wood'); break;
        }
    }

    /**
     * Name of the class of the resource by type
     * @param <int> $type
     * @return <string>
     */
    ...
    function peoples_by_level($level = 1)
    {
        ...
        return ($level > 48) ? 6760 + (($level - 48) * 250) : 60; // Change 60 to $level?
    }

    /**
     * The number of scientists by level
     * @param <int> $level
     * @return <int>
     */
    function scientists_by_level($level = 0)
    {
        ...
        // For the future, to 20 scientists at every level
    }

    /**
     * Prices at the time of the mine, the number of employees
     * @param <int> $id
     * @param <int> $level
     * @return <array>
     */
    ...
    /**
     * Prices of building structures and the time
     * @param <int> $id
     * @param <int> $level
     * @return <array>
     */
    function building_cost($id = 1, $level = 0, $research, $levels)
    {
        ...
        $minus_crystal = 0;
        $minus_sulfur = 0;
        // Studies have reduced the cost of building
        // Pulley
    ...
    /**
     * Name of happiness by the count number
     * @param <int> $count
     * @return <string>
     */
    function good_name_by_count($count = 0)
    {
        if ($count <= -50)
        {
            return $this->lang->line('outraged');
        }
        elseif($count > -50 and $count <= -1)
        {
            return $this->lang->line('sad');
        }
        elseif($count >= 0 and $count < 50)
        {
            return $this->lang->line('neutral');
        }
        elseif($count >= 50 and $count < 300)
        {
            return $this->lang->line('happy');
        }
        elseif($count >= 300)
        {
            return $this->lang->line('ecstatic');
        }
    }

    /**
     * Class of happiness by the count number
     * @param <int> $count
     * @return <string>
     */
    ...
    function wonder_name_by_type($type) {
        return $this->lang->line('wonder_'.$type);
    }
    ...
    {
        if ($type <= 8 and $level <= 5) {
            return $this->lang->line('wonder'.$type.'_level'.$level);
        }
    }
    ...
    {
        return $this->lang->line('wonder'.$type .'_desc');
    }

    /**
     * Wonder effect by type and level
     * @param <int> $type
     * @return <string>
     */
    function wonder_effect_by_type_and_level($type, $level)
    {
        return $this->lang->line('wonder'.$type.'_level'.$level);
    }

    /**
     * Wonder duration by type
     * @param <int> $type
     * @return <string>
     */
    function wonder_duration_by_type($type)
    {
        switch ($type) {
            case 1: return '1 '.$this->lang->line('day'); break;
            case 2: return '16 '.$this->lang->line('hours'); break;
            case 3: return '1 '.$this->lang->line('day'); break;
            case 4: return '1 '.$this->lang->line('day'); break;
            case 5: return '4 '.$this->lang->line('hours'); break;
            case 6: return '12 '.$this->lang->line('hours'); break;
            case 7: return '4 '.$this->lang->line('hours'); break;
            case 8: return ''; break;
        }
    }

    /**
     * Wonder cooldown by type
     * @param <int> $type
     * @return <string>
     */
    function wonder_cooldown_by_type($type)
    {
        switch ($type) {
            case 1: return '7 '.$this->lang->line('days'); break;
            case 2: return '4 '.$this->lang->line('days'); break;
            case 3: return '9 '.$this->lang->line('days'); break;
            case 4: return '7 '.$this->lang->line('days'); break;
            case 5: return '1 '.$this->lang->line('day'); break;
            case 6: return '3 '.$this->lang->line('days'); break;
            case 7: return '1 '.$this->lang->line('day'); break;
            case 8: return '3 '.$this->lang->line('days'); break;
        }
    }
    /**
     * Prices of premiums
    ...
    /**
     * The number of wine by tavern level
     * @param <int> $level
     * @return <int>
     */
    ...
    /**
     * Price on the amount of cargo ship
     * @param <int> $count
     * @return <int>
     */
