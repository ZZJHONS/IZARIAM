<div id="pwd">
    	<img class="bild1" src="<?=$this->config->item('style_url')?>img/bild1.jpg" width="173" height="85">
    	<img class="bild2" src="<?=$this->config->item('style_url')?>img/bild2.jpg" width="173" height="85">
        ...
        <p class="desc">
            ...
            <img src="<?=$this->config->item('style_url')?>img/ok-neu.gif"><?=$this->lang->line('success_password')?><br />
            <?}else{?>
