...
<div id="mainview">
    ...
    <div id="goToResearch" class="contentBox01h">
        <h3 class="header"><?=$this->lang->line('research_points')?>: <?=floor($this->Player_Model->research->points)?><img alt="<?=$this->lang->line('research_points')?> icon" src="<?=$this->config->item('style_url')?>skin/resources/icon_research.gif" class="iconResearch" style="float: none;"></h3>
        <div class="centerButton">
            <a class="button" href="<?=$this->config->item('base_url')?>game/researchAdvisor/"><?=$this->lang->line('research_advisor')?></a>
        </div>
        <div class="footer"></div>
    </div>
</div>
