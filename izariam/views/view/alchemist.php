<div id="mainview">
    ...
    <div class="contentBox01h">
        <div class="buildingPictureImg"><img src="<?=$this->config->item('style_url')?>skin/img/city/small/building_alchemist.gif" /></div>
        <h3 class="header"><span class="textLabel"><?=$this->lang->line('sulfur_extraction')?></span></h3>
        <div class="content">
            <table cellspacing="0" cellspacing="0" border="0" style="margin:0 auto 0px;">
                ...
                <tr>
                    <td class="col1Style">
                        ...
                        <label><?=$this->lang->line('base_productivity')?>: </label>

                    </td>
                    <td class="col2Style">
                        <span title="<?=$this->lang->line('base_productivity')?>"><?=number_format($production)?></span>
                    </td>
                    <td class="col3Style">
                ...
                <tr class='alt'>
                    <td class="col1Style">
                        <label><?=$this->lang->line('building20_name')?>: </label>
                    </td>
                    <td class="col2Style">
                        <span title="<?=$this->lang->line('building20_name')?>"><?=number_format($bonus)?></span>
                    </td>
                    <td class="col3Style">
