...
<div id="mainview">
    <div class="informations">
        <h1 class="informationsTitel"><?=$this->lang->line('pedia0_0')?></h1>
        <h2><?=$this->lang->line('pedia0_0_1')?></h2>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td width="50%" align="right">
                        <a title="<?=$this->lang->line('foward_topic')?>: <?=$this->lang->line('information2_1')?>" href="<?=$this->config->item('base_url')?>game/pedia/2/"><?=$this->lang->line('information2_1')?><img align="middle" name="next" onMouseover="next.src='<?=$this->config->item('style_url')?>skin/layout/next-hover.gif';" onMouseout="next.src='<?=$this->config->item('style_url')?>skin/layout/next.gif';" src="<?=$this->config->item('style_url')?>skin/layout/next.gif"></a>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="navigation">
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <a title="<?=$this->lang->line('back_topic')?>: <?=$this->lang->line('information1_1')?>" href="<?=$this->config->item('base_url')?>game/pedia/1/"><img align="middle" name="prev" onMouseover="prev.src='<?=$this->config->item('style_url')?>skin/layout/prev-hover.gif';" onMouseout="prev.src='<?=$this->config->item('style_url')?>skin/layout/prev.gif';" src="<?=$this->config->item('style_url')?>skin/layout/prev.gif"><?=$this->lang->line('information1_1')?></a></td>
                    <td width="50%" align="right">
                    <a title="<?=$this->lang->line('foward_topic')?>: <?=$this->lang->line('information3_1')?>" href="<?=$this->config->item('base_url')?>game/pedia/3/"><?=$this->lang->line('information3_1')?><img align="middle" name="next" onMouseover="next.src='<?=$this->config->item('style_url')?>skin/layout/next-hover.gif';" onMouseout="next.src='<?=$this->config->item('style_url')?>skin/layout/next.gif';" src="<?=$this->config->item('style_url')?>skin/layout/next.gif"></a></td>
                </tr>
            </table>
        </div>
    </div>
