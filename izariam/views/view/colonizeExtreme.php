<div id="mainview">
    <div class="buildingDescription">
        <h1>Colonise</h1>
        <p>This building ground, made of solid granite was created by the gods themselves. Beyond that it does not offer you any more advantages in comparison to other building grounds. Either way, everyone who is planning on settling here should have an adequate amount of Ambrosia available.</p>
    </div>
    <div id="moveCity" class="contentBox01h" style="z-index:55">
        ...
        <div class="content" id="relatedCities">
            <p>This is a premium building ground. It will cost you 400 Ambrosia to move a colony to this building ground.</p>
            <div class="cityMoveDiv">
				<?php
					$this->load->helper('form');
					echo form_open('actions/colonizeExtreme/'.$id.'/'.$position);
				?>
                <div style="height:100px">
                    ...
                    <table style="width:400px;background-color:#FFFBEC;border:1px solid #FBE7C0;margin-top:45px;">
                        <tr>
                            ...
                            <td>400<img height="20" width="24" title="<?=$this->lang->line('ambrosy')?>" alt="<?=$this->lang->line('ambrosy')?>" src="<?=$this->config->item('style_url')?>skin/premium/ambrosia_icon.gif"/></td>
                            <td style="padding-bottom:10px;">
                            <?if($this->Player_Model->user->ambrosy < 400){?>
                                <a class="notenough" style="color:#999;font-weight:normal;font-size:11px;text-decoration:none" href="<?=$this->config->item('base_url')?>game/premium/">400 <?=$this->lang->line('ambrosy_missing')?><br><span class="buyNow" style="text-decoration:underline"><?=$this->lang->line('acquire_now')?></span></a>
                            <?}else{?>
