<div id="mainview">
    ...
    <table cellspacing="0" cellspacing="0" id="balance" class="table01">
        <tr>
        	<th class="city"><img src="<?=$this->config->item('style_url')?>skin/layout/icon-city2.gif" alt="<?=$this->lang->line('town')?>" /></th>
        ...
        <tr >
            ...
            <td class="value res"><?$scientists = ($rashod < 0) ? '<span class="negative">'.number_format($rashod).'</span>' : number_format($rashod) ;?><?=$scientists?></td>
        ...
        <?}?>
     	<tr class="result">
     		...
     		<td class="value res"><?$scientists_all = ($summ_rashod < 0) ? '<span class="negative">'.number_format($summ_rashod).'</span>' : number_format($summ_rashod) ;?><?=$scientists_all?></td>
    ...
    <table cellspacing="0" cellpadding="0" id="upkeepReductionTable" class="table01" border="0px">
        <tr>
            <th colspan="4"><?=$this->lang->line('basic_cost')?></th>
        </tr>
        <tr >
            <td class="reason"><?=$this->lang->line('troops')?></td>
            <td class="costs"><?=number_format($army_gold)?></td>
            <td class="bar">
                <div class="greenBarDiv barBorder" style="width:99%" title="<?=$this->lang->line('cost')?>">
                    <div class="brownBarDiv" style="width:100%" title="<?=$this->lang->line('cost')?>"></div>
                </div>
            </td>
            <td class="hidden negative"></td>
        </tr>
        <tr class="altbottomLine">
            <td class="reason">- <?=$this->lang->line('researches')?> (<?$all_percent = ($army_gold_research > 0 and $army_gold > 0) ? floor(($army_gold_research/$army_gold)*100) : '100'?><?=(100 - $all_percent)?>%)</td>
            <td class="boldcosts"><?=number_format($army_gold_research)?></td>
            <td class="bar">
                <div class="greenBarDiv barBorder" style="width:99%" title="<?=$this->lang->line('cost')?>">
                    <div class="brownBarDiv" style="width:<?if($army_gold_research > 0 and $army_gold > 0){?><?=floor(($army_gold_research/$army_gold)*100)?><?}else{?>100<?}?>%" title="<?=$this->lang->line('cost')?>"></div>
                </div>
            </td>
        ...
        <tr class="altbottomLine">
            <td class="reason">- <?=$this->lang->line('researches')?> (<?$all_percent2 = ($fleet_gold_research > 0 and $fleet_gold > 0) ? floor(($fleet_gold_research/$fleet_gold)*100) : '100'?><?=(100 - $all_percent2)?>%)</td>
            <td class="boldcosts"><?=number_format($fleet_gold_research)?></td>
            <td class="bar">
                <div class="greenBarDiv barBorder" style="width:99%" title="<?=$this->lang->line('cost')?>">
                    <div class="brownBarDiv" style="width:<?if($fleet_gold_research > 0 and $fleet_gold > 0){?><?=floor(($fleet_gold_research/$fleet_gold)*100)?><?}else{?>100<?}?>%" title="<?=$this->lang->line('cost')?>"></div>
                </div>
            </td>
    ...
    <table cellspacing="0" cellpadding="0" id="upkeepReductionTable" class="table01" border="0px">
        <tr>
            <th colspan="4"><?=$this->lang->line('supply_costs')?></th>
        </tr>
        <tr >
            <td class="reason"><?=$this->lang->line('troops')?></td>
            <td class="costs"><?=number_format($army_gold)?></td>
    ...
    <table cellspacing="0" cellpadding="0" id="upkeepReductionTable" class="table01" border="0px">
            ...
            <td class="costs"></td>
     		<td class="bar">
                <div class="greenBarDiv barBorder" style="width:99%" title="<?=$this->lang->line('income')?>">
                    <div class="brownBarDiv" style="width: 100%" title="<?=$this->lang->line('income')?>"></div>
                </div>
            </td>
        ...
        <tr>
            ...
            <td class="hidden<?$upkeep = ($all_army_gold < 0) ? ' negative' : ''?><?=$upkeep?>"><?=number_format($all_army_gold)?></td>
        </tr>
        <tr class="result">
            <td class="reason"><img src="<?=$this->config->item('style_url')?>skin/layout/sigma.gif" alt="<?=$this->lang->line('total')?>" /></td>
            <td class="costs"></td>
     		<td class="bar"></td>
            <td class="hidden<?$result = (($summ_ostalos - ($all_army_gold*-1)) < 0) ? ' negative' : ''?><?=$result?>"><?=number_format($summ_ostalos - ($all_army_gold*-1))?></td>
        </tr>
    </table>
</div> 