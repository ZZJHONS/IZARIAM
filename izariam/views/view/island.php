<div id="mainview" class="island<?=$this->Island_Model->island->type?>">
    ...
    <ul id="cities">
        ...
        <li id="cityLocation<?=$i?>" class="cityLocation city level<?=$this->Island_Model->towns[$i]->pos0_level?>">
            ...
            <ul class="cityinfo">
                ...
                <li class="owner">
                    <span class="textLabel"><?=$this->lang->line('player')?>: </span><?=$this->Island_Model->users[$i]->login?>
        ...
        <?}?>
        <?}?>
        <li id="cityLocation16" class="cityLocation premiumBuildPlace">
            <div class="claim"></div>
            <a href="<?=$this->config->item('base_url')?>game/colonizeExtreme/<?=$this->Island_Model->island->id?>/16" title="Would you like to colonise here?" class="">
                <span class="textLabel">
                    <span class="before"></span>
                    Building ground<span class="after"></span>
                </span>
            </a>
        </li>
        <?if($this->Island_Model->island->id == $this->Player_Model->island_id){?>
        <li id="barbarianVilliage">
            <a href="#" id="barbarianLink" onclick="selectBarbarianVillage(); selectGroup.activate(this, 'cities'); return false;" class=""> </a>
            ...
            <ul class="cityactions" id="barbarianActions">
                ...
                ?>
                <li class="plundering">
                    <a href="<?=$this->config->item('base_url')?>game/plunder/<?=$this->Player_Model->island_id?>/0/" title="<?=$this->lang->line('pillage')?>"><?=$this->lang->line('pillage')?></a>
                </li>
                <?}else{?>
                <li class="plundering disabled" title="<?=$this->lang->line('not_pillage')?>">
                    <a id="barbarianPlundering" href="javascript:void(0);" title="<?=$this->lang->line('not_pillage')?>"><?=$this->lang->line('pillage')?></a>
                </li>
                <?}?>    
            </ul>
        </li>
    ...
    <ul id="islandfeatures">
        ...
        <li id="resource" class="<?=$this->Data_Model->resource_class_by_type(0)?> level<?=$this->Island_Model->island->wood_level?>">
        ...
        <li id="wonder" class="wonder<?=$this->Island_Model->island->wonder?>">
            <a href="<?=$link_wonder?>" title="<?=$this->Data_Model->wonder_name_by_type($this->Island_Model->island->wonder)?>">
                <span class="textLabel"><?=$this->Data_Model->wonder_name_by_type($this->Island_Model->island->wonder)?></span>
            </a>
        </li>
        <?}?>
        <li class="forum">
            <a title="<?=$this->lang->line('agora')?>" href="<?=$link_forum?>">
