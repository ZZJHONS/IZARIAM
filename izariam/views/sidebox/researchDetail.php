<div id="civilopedia_menu" class="dynamic" style="margin-bottom:10px;">
    ...
    <div class="main">
        <ul>
            ...
            <li>
                  <a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('researches')?>..." href="<?=$this->config->item('base_url')?>game/researchDetail/"><?=$this->lang->line('researches')?></a>
                  <ul>
