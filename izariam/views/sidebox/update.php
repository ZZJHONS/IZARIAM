...
<div id="buildingUpgrade" class="dynamic">
    ...
    <div class="content">
        <div class="buildingLevel">
            <span class="textLabel"><?=$this->lang->line('level')?> </span><?=$level?>
        </div>
        ...
        <ul class="resources">
            ...
            <?}?>
            <?if($cost['marble'] > 0){?>
            <li class="marble" title="<?=$this->lang->line('marble')?>"><span class="textLabel"><?=$this->lang->line('marble')?>: </span><?=number_format($cost['marble'])?></li>
            <?}?>
            <?if($cost['crystal'] > 0){?>
