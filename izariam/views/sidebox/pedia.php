<div id="civilopedia_menu" class="dynamic" style="margin-bottom:10px;">
    ...
    <div class="main">
        <ul>
            <li>
                <a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('pedia0_0')?>..." href="<?=$this->config->item('base_url')?>game/pedia/0/"><?=$this->lang->line('pedia0_0')?></a>
                <?if($id >=0 and $id <= 4){?>
                <ul>
                    <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_2_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/1/"><?=$this->lang->line('information_2_title')?></a></li>
                    <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_3_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/2/"><?=$this->lang->line('information_3_title')?></a></li>
                    <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_4_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/3/"><?=$this->lang->line('information_4_title')?></a></li>
                </ul>
                <?}?>
            </li>
            <li>
                <a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_5_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/20/"><?=$this->lang->line('information_5_title')?></a>
                <?if($id >= 20 and $id <= 26){?>
                <ul>
                      <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_6_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/21/"><?=$this->lang->line('information_6_title')?></a></li>
                      <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_7_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/22/"><?=$this->lang->line('information_7_title')?></a></li>
                      <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_8_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/23/"><?=$this->lang->line('information_8_title')?></a></li>
                      <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_9_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/24/"><?=$this->lang->line('information_9_title')?></a></li>
                      <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_10_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/25/"><?=$this->lang->line('information_10_title')?></a></li>
                      <li><a title="<?=$this->lang->line('learn_more')?> <?=$this->lang->line('information_11_title')?>..." href="<?=$this->config->item('base_url')?>game/pedia/26/"><?=$this->lang->line('information_11_title')?></a></li>
                </ul>
                <?}?>
            </li>
            <li>
