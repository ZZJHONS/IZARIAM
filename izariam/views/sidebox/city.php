...
<div class="dynamic" id="reportInboxLeft">
    ...
    <div class="content">
        ...
        <div class="currentUnit <?=$this->Data_Model->building_class_by_type($type)?>">
            ...
            <div class="amount">
                <span class="textLabel"><?=$this->Data_Model->building_name_by_type($type)?> (<?=$levels[$this->Player_Model->build_line[$this->Player_Model->town_id][0]['position']]+1?>)</span>
            </div>
            <div class="progressbar">
                <div class="bar" id="buildProgress" title="<?=$percent?>%" style="width:<?=$percent?>%;"></div>
            </div>
            <div class="time" id="buildCountDown">
                <?=format_time($ostalos_all)?><span class="textLabel"> <?=$this->lang->line('to_complete')?></span>
            </div>
        </div>
        <script type="text/javascript">
        	getCountdown({
