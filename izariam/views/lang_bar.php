					...
					<div id="mmoLangSelect" class="mmoSelectbox">
						...
						<div class="mmoOptionsDivInvisible" id="mmoOptionsDiv1">
							<ul class="mmoLangList mmoListHeight" id="mmoList1">
								<li<?langList('arabic', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_AE"><?=$this->lang->line('ae')?></a></li>
								<li<?langList('bulgarian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_BG"><?=$this->lang->line('bg')?></a></li>
								<li<?langList('chinese', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_HK"><?=$this->lang->line('hk')?></a></li>
								<li<?langList('chinese', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_TW"><?=$this->lang->line('tw')?></a></li>
								<li<?langList('czech', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_CZ"><?=$this->lang->line('cz')?></a></li>
								<li<?langList('danish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_DK"><?=$this->lang->line('dk')?></a></li>
								<li<?langList('dutch', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_NL"><?=$this->lang->line('nl')?></a></li>
								<li<?langList('english', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_EN"><?=$this->lang->line('en')?></a></li>
								<li<?langList('english', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_US"><?=$this->lang->line('us')?></a></li>
								<li<?langList('finnish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_FI"><?=$this->lang->line('fi')?></a></li>
								<li<?langList('french', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_FR"><?=$this->lang->line('fr')?></a></li>
								<li<?langList('german', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_DE"><?=$this->lang->line('de')?></a></li>
								<li<?langList('greek', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_GR"><?=$this->lang->line('gr')?></a></li>
								<li<?langList('hebrew', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_IL"><?=$this->lang->line('il')?></a></li>
								<li<?langList('hungarian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_HU"><?=$this->lang->line('hu')?></a></li>
								<li<?langList('italian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_IT"><?=$this->lang->line('it')?></a></li>
								<li<?langList('latvian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_LV"><?=$this->lang->line('lv')?></a></li>
								<li<?langList('lithuanian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_LT"><?=$this->lang->line('lt')?></a></li>
								<li<?langList('norwegian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_NO"><?=$this->lang->line('no')?></a></li>
								<li<?langList('persian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_IR"><?=$this->lang->line('ir')?></a></li>
								<li<?langList('polish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_PL"><?=$this->lang->line('pl')?></a></li>
								<li<?langList('portuguese', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_BR"><?=$this->lang->line('br')?></a></li>
								<li<?langList('portuguese', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_PT"><?=$this->lang->line('pt')?></a></li>
								<li<?langList('romanian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_RO"><?=$this->lang->line('ro')?></a></li>
								<li<?langList('russian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_RU"><?=$this->lang->line('ru')?></a></li>
								<li<?langList('serbian', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_RS"><?=$this->lang->line('rs')?></a></li>
								<li<?langList('slovak', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_SK"><?=$this->lang->line('sk')?></a></li>
								<li<?langList('slovene', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_SI"><?=$this->lang->line('si')?></a></li>
								<li<?langList('spanish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_AR"><?=$this->lang->line('ar')?></a></li>
								<li<?langList('spanish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_CL"><?=$this->lang->line('cl')?></a></li>
								<li<?langList('spanish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_CO"><?=$this->lang->line('co')?></a></li>
								<li<?langList('spanish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_MX"><?=$this->lang->line('mx')?></a></li>
								<li<?langList('spanish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_PE"><?=$this->lang->line('pe')?></a></li>
								<li<?langList('spanish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_ES"><?=$this->lang->line('es')?></a></li>
								<li<?langList('venezuela', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_VE"><?=$this->lang->line('ve')?></a></li>
								<li<?langList('swedish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_SE"><?=$this->lang->line('se')?></a></li>
								<li<?langList('turkish', $userdata, $item, $item2)?> target="_top" class="mmoflag mmo_TR"><?=$this->lang->line('tr')?></a></li>
							</ul>
						</div>
					</div>
				</div>
